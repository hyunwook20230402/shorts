...
씬-오디오-타임스탬프 파일 매핑:
```python
# 오디오 파일명 패턴: step2_scene{NN}_sent{MM}_audio.mp3
# alignment 파일명 패턴: step2_scene{NN}_sent{MM}_alignment.json
# 경로: cache/{poem_id}/step2_scene{NN}_sent{MM}_audio.mp3
