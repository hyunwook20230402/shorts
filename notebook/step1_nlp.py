...
4. main_focus: "background"/"character"/"object" 중 택 1
5. visual_elements: {{"background":"...","character":"...","object":"...","atmosphere":"..."}} 영어 키워드
6. 입력된 원문 행 외의 내용을 생성하지 마세요.
7. **언어 규칙**: modern_text, emotion은 반드시 **한국어**. visual_elements만 영어.

## 출력 형식 (JSON만 출력, 설명 금지)
{{"original_text":"...","modern_text":"...","emotion":"...","main_focus":"...","visual_elements":{{"background":"...","character":"...","object":"...","atmosphere":"..."}}}}
"""
...
- 지배적 정서 톤 (시 전체 조명/색감에만 참고로 반영영): {emotion_tone}
