...
5. scene_description: 원문 장면의 핵심 시각 요소를 **영어** 키워드/구절로 묘사 (60토큰 이내). main_focus에 포함된 모든 요소(배경장소,계절,시간,날씨,인물 행동,표정,사물)를 포함.
...
원문의 행동 동사를 참고해 아래 9종 중 가장 적합한 pose_type을 선택하세요:
...
줄2 (main_focus에 "character" 포함 시에만): pose_type: [위 9종 중 1개]
main_focus에 "character"가 없으면 줄2 출력 금지."""
